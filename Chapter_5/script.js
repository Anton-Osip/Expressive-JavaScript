...
console.log(arr.reduce((arr, elem) => arr.concat(elem)))
console.log('-----------------------------------------')
console.log('-----------------------------------------')

console.log('Ваш собственный цикл')
...
console.log('Доминирующее направление письма')
console.log('-----------------------------------------')
let SCRIPTS = [
	{
		name: 'Adlam',
...
function direct(list) {
	...
	let res = Math.max(obj.ltr, obj.rtl, obj.ttb)
	console.log(obj)
	console.log(res)
}
direct(SCRIPTS)
